...
if (isset($_POST['login'])) { //formsubmitted is for execute data from login form
    ...
    $query = $conn->query("SELECT * FROM log21 WHERE username='$username' and password = '$pass'");   
        $count = $query->num_rows>0; //count result from your query
    if ($count==1) // if total data = 1 then continue
        { 
          $_SESSION = $query->fetch_array();
           
            header("Location:../../uts_gis/uts_gis/gis/index.html");
          }
          else
        {             
  ...
  ?> 
 <div class="limiter">
  <div class="container-login100" style="background-image: url('images/hotel12.jpg');">
   <div class="wrap-login100 p-l-55 p-r-55 p-t-5 p-b-5">
